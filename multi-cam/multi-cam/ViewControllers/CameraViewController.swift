...
//
//
//        // I don't think a multicamsession can have multipe outputs
...
//            }
//
////            let photoOutput1 = AVCapturePhotoOutput()
////            guard captureSession.canAddOutput(photoOutput1) else { return }
//////            captureSession.sessionPreset = AVCaptureSession.Preset.medium
////            captureSession.addOutput(photoOutput1)
...
////            }
////
//////            let photoOutput2 = AVCapturePhotoOutput()
//////            guard captureSession.canAddOutput(photoOutput2) else { return }
////////            captureSession.sessionPreset = AVCaptureSession.Preset.medium
//////            captureSession.addOutput(photoOutput2)
////////            captureSession.commitConfiguration()
//////
////            print("should not", captureSession.canAddOutput(photoOutput))
////            if captureSession.canAddOutput(photoOutput) {
////                captureSession.addOutput(photoOutput)
////            }
////////
...
////        }
////
//        if let captureDevice3 = AVCaptureDevice.default(.builtInWideAngleCamera, for: AVMediaType.video, position: .front) {
//            do {
...
//            }
////
////            let photoOutput3 = AVCapturePhotoOutput()
////            guard captureSession.canAddOutput(photoOutput3) else { return }
//////            captureSession.sessionPreset = AVCaptureSession.Preset.medium
